...
//                     {(isLoading || updateBeneficiaryMutation.isLoading) && <TopBarProgress />}
//                     {isError && setErrMsg("Something went wrong")}
//                     {/* Error Handling */}
...
//                                 <div className="flex md:flex-row flex-col md:pt-10 ">
//                                     <div className="md:ml-10 md:mt-0 mt-5">
//                                         <label
//                                             htmlFor="phone"
//                                             className="block text-md font-medium text-gray-500"
...
//                                 <div className="flex md:flex-wrap md:flex-row flex-col md:pt-10">
//                                     <div className="md:ml-10 md:mt-0 mt-5">
//                                         <label
//                                             htmlFor="city"
//                                             className="block text-md font-medium text-gray-500"
