...
const SignUpForm = () => {
    ...
    const onSubmit = async (values, actions) => {
        ...
        try {
            await axios.post(REGISTER_URL, JSON.stringify({ firstName, lastName, phone, email, password }), {
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit} autoComplete="off">
                        ...
                        <input
                            ...
                            } w-full border border-gray-300 px-3 py-2 text-gray-500 rounded-md focus:outline-none focus:ring-1`}
                        />
                        {errors.firstName && touched.firstName && (
                        ...
                        />
                        {errors.phone && touched.phone && (
                            <p className="text-red-500 normal-case text-xs mt-2">{errors.phone}</p>
                        )}
                        ...
                        />
                        {errors.email && touched.email && (
                            <p className="text-red-500 normal-case text-xs mt-2">{errors.email}</p>
                        )}
                        ...
                        <p className="md:text-lg text-xs text-slate-500 mt-3">
                            ...
                            <a href="https://ihsmia.com/terms" className="text-ihs-green">
                                {" "}
                                Terms of Use{" "}
                            </a>
                            and
                            <a href="https://ihsmia.com/privacy-policy" className="text-ihs-green">
                                {" "}
                                Privacy Policy.
                            </a>
                        </p>
