...
// import { AnnotationIcon, ChevronLeftIcon } from "@heroicons/react/outline";
...
//                             <h3 className="md:text-3xl text-lg py-8 md:px-8 px-2">Review Appointment</h3>
//                         </div>
//                     </div>
...
//                             <div>
//                                 <label htmlFor="review" className="block text-md font-medium text-gray-500">
...
//                             <div>
//                                 <label htmlFor="rating" className="block text-md font-medium text-gray-500">
