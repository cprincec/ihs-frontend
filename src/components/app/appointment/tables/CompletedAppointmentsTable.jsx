...
// 	const completedAppointments = appointmentsProp.filter((appointment) =>
...
// 		return completedAppointments.slice(firstPageIndex, lastPageIndex);
// 	}, [currentPage, completedAppointments]);
...
// 											<p className="text-lg md:mx-32 mx-5 text-center">No Completed Appointments.</p>
// 										</div>
// 									</td>
// 								</tr>
// 							}
...
// 							totalCount={completedAppointments.length}
