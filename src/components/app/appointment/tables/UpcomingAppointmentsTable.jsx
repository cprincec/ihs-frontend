...
//     const upcomingAppointments = appointmentsProp.filter(
...
//                                         <tr
//                                             className="py-4 whitespace-no-wrap border-b border-gray-200"
//                                             key={el.id}
//                                         >
//                                             <td>
//                                                 <div className="mx-4">
//                                                     <Avatar
//                                                         name={`${el?.beneficiaryName}`}
...
//                                                 <span
//                                                     className={
//                                                         el?.completed.toString() === booleanString.True
...
//                                             <td className="px-6 py-4 md:text-lg text-base leading-5 text-ihs-green ">
//                                                 <Link to={`/${urlPath}/viewappointment/${el?.id}`}>View</Link>
//                                             </td>
//                                         </tr>
//                                     ))
//                                 ) : (
