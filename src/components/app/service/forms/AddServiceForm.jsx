...
const AddServiceForm = ({ handleCancelClick, setFormSuccess }) => {
        ...
        <div>
            <div className="flex items-center justify-between">
                <div className="flex gap-x-2 items-center justify-center justify-items-center">
                    ...
                    <h2 className="md:text-xl font-semibold text-gray-800">Add Service</h2>
                </div>
                <span
            ...
            <Formik initialValues={initialValues} validationSchema={addServiceSchema} onSubmit={handleSubmit}>
                {({ errors }) => (
                    <Form className="grid gap-y-3 mt-8">
                        <div className="grid">
                            ...
                            <ErrorMessage
                                ...
                                component="div"
                                className={`${
                                    errors.name ? "animate-fly-in-y" : "animate-fly-out-y"
                        ...
                        <div className="grid">
                            ...
                            <ErrorMessage
                                ...
                                component="p"
                                className={`${
                                    errors.category ? "animate-fly-in-y" : "animate-fly-out-y"
                                } text-red-500 text-xs mt-1 transition-all duration-500`}
                            />
                        </div>
