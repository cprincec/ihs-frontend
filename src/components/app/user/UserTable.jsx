...
// import { filterById } from "../../../utils/utililtyFunctions";
...
//   users = filterById(users, loggedInUser.id);
...
//   return (
//     <>
//       <div className="hidden sm:block lg:flex flex-col mt-8">
...
//                       <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
//                         <span className="inline-flex p-2 py-2 text-xs font-semibold leading-5 text-green-800 bg-green-100 rounded-md capitalize">
//                           {user?.userType}
//                         </span>
//                       </td>
...
//           <div className="inline-block min-w-full align-middle rounded-md">
//             <table className="table-auto min-w-full">
//               <thead>
//                 <tr>
//                   <th className="px-6 py-5 text-base font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-ihs-green-shade-50">
//                     <p></p>
//                   </th>
//                 </tr>
//               </thead>
...
const UsersTable = ({ users }) => {
    ...
    const mobileScreenHeaders = ["User", "Role"];
    ...
    const columns = [
        ...
        },
        {
            ...
            accessorKey: "actions",
            cell: (cell) => (
                <Link className="text-ihs-green" to={`viewuser/${cell.row.original.id}`}>
                    View
                </Link>
            ),
        },
